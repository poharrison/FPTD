...
import numpy as np
import h5py
from FPTD.auxfunctions import map_to_integers, normalize_markov_matrix
from FPTD.auxfunctions import pops_from_nm_tmatrix, pops_from_tmatrix
from FPTD.auxfunctions import pseudo_nm_tmatrix, weighted_choice
from FPTD.mfpt import direct_mfpts, non_markov_mfpts, fpt_distribution
from FPTD.mfpt import direct_fpts, markov_mfpts
from FPTD.ensembles import DiscreteEnsemble, DiscretePathEnsemble
...
class NonMarkovModel(DiscreteEnsemble):
    ...
    def __init__(self, trajectories, stateA, stateB, reweight_file,
        ...
        self.stateA = stateA
        self.stateB = stateB
        self.reweight_file = reweight_file
